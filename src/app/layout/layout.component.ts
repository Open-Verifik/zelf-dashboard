...
// import { SettingsComponent } from './common/settings/settings.component'; // Removed to hide settings from clients
...
@Component({
	...
	imports: [
		...
		// SettingsComponent, // Removed to hide settings from clients
	],
})
